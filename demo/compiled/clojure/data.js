...
return cljs.core.reduce.call(null,(function (result,p__21495){
...
var vec__21499 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__21499,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__21499,(1),null);
var ab = cljs.core.nth.call(null,vec__21499,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_21505 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_21505.call(null,x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_21506 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_21506.call(null,a,b);
}
});
...
return (function (){var G__21510 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__21510__$1)].join('')));
...
//# sourceMappingURL=data.js.map?rel=1726541909699
