...
var len__5726__auto___21725 = arguments.length;
var i__5727__auto___21726 = (0);
while(true){
if((i__5727__auto___21726 < len__5726__auto___21725)){
args__5732__auto__.push((arguments[i__5727__auto___21726]));

var G__21727 = (i__5727__auto___21726 + (1));
i__5727__auto___21726 = G__21727;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq21722){
...
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21723,G__21724,seq21722__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__21728_SHARP_){
return (!((cljs.core.meta.call(null,p1__21728_SHARP_) == null)));
})))){
...
var map__21729 = opts;
var map__21729__$1 = cljs.core.__destructure_map.call(null,map__21729);
var markup_db = cljs.core.get.call(null,map__21729__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e21730){var e__20691__auto__ = e21730;
return false;
}})();
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
...
}catch (e21732){var e__20691__auto__ = e21732;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__21734 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__21735 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__21735);

try{var map__21736 = opts;
var map__21736__$1 = cljs.core.__destructure_map.call(null,map__21736);
var markup_db = cljs.core.get.call(null,map__21736__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__21734);
}});
...
var temp__5821__auto___21740 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5821__auto___21740)){
var managed_print_level_21741 = temp__5821__auto___21740;
var _STAR_print_level_STAR__orig_val__21738_21742 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__21739_21743 = managed_print_level_21741;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__21739_21743);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__21737_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__21737_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__21738_21742);
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1726541910151
