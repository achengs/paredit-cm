...
var map__22303 = top_item;
var map__22303__$1 = cljs.core.__destructure_map.call(null,map__22303);
...
}catch (e22302){var _e = e22302;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5821__auto___22304 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5821__auto___22304)){
var seen_errors_22305 = temp__5821__auto___22304;
if(cljs.core.truth_(seen_errors_22305.has(self))){
} else {
seen_errors_22305.add(self);

var temp__5823__auto___22306 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5823__auto___22306)){
var sense_22307 = temp__5823__auto___22306;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_22307)].join(''));
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1726541910925
