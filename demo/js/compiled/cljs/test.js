...
return cljs.core.assoc.call(null,G__6629,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__6629;
}
}));
...
var len__5726__auto___6634 = arguments.length;
var i__5727__auto___6635 = (0);
while(true){
if((i__5727__auto___6635 < len__5726__auto___6634)){
args__5732__auto__.push((arguments[i__5727__auto___6635]));

var G__6636 = (i__5727__auto___6635 + (1));
i__5727__auto___6635 = G__6636;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq6631){
...
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__6632,G__6633,seq6631__$2);
}));
...
var map__6638 = m;
var map__6638__$1 = cljs.core.__destructure_map.call(null,map__6638);
var file = cljs.core.get.call(null,map__6638__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__6638__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__6638__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__6637_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__6637_SHARP_));
...
var temp__5823__auto___6639 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5823__auto___6639)){
var message_6640 = temp__5823__auto___6639;
cljs.core.println.call(null,message_6640);
} else {
}
...
var temp__5823__auto___6641 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5823__auto___6641)){
var message_6642 = temp__5823__auto___6641;
cljs.core.println.call(null,message_6642);
} else {
}
...
var output_dir = "resources/test/js/compiled";
var output_dir__$1 = (function (){var G__6643 = output_dir;
...
var G__6644 = exception.stack;
var G__6644__$1 = (((G__6644 == null))?null:clojure.string.split_lines.call(null,G__6644));
var G__6644__$2 = (((G__6644__$1 == null))?null:cljs.core.get.call(null,G__6644__$1,depth));
if((G__6644__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__6644__$2);
}
} else {
...
var vec__6645 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__6645,(0),null);
var column = cljs.core.nth.call(null,vec__6645,(1),null);
var vec__6648 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__6648,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__6648,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__6648,(2),null);
...
var m__$1 = (function (){var G__6651 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__6651__$1 = (((G__6651 instanceof cljs.core.Keyword))?G__6651.fqn:null);
switch (G__6651__$1) {
case "fail":
...
var G__6655 = (function (){var G__6654 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__6654);
} else {
return G__6654;
}
})();
...
return cljs.core.vary_meta.call(null,G__6656,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e6657){var e = e6657;
var G__6658 = e;
var G__6658__$1 = (((G__6658 instanceof cljs.core.Keyword))?G__6658.fqn:null);
switch (G__6658__$1) {
...
var vec__6660 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__6660,(0),null);
var types = vec__6660;
...
return cljs.core.map.call(null,(function (p__6663){
var vec__6664 = p__6663;
var ns = cljs.core.nth.call(null,vec__6664,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__6664,(1),null);
return (function (){
...
var G__6667 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__6667__$1 = (((G__6667 instanceof cljs.core.Keyword))?G__6667.fqn:null);
switch (G__6667__$1) {
case "async":
...
var seq__6668 = cljs.core.seq.call(null,vars__$1);
var chunk__6669 = null;
var count__6670 = (0);
var i__6671 = (0);
while(true){
if((i__6671 < count__6670)){
var v = cljs.core._nth.call(null,chunk__6669,i__6671);
var temp__5823__auto___6673 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5823__auto___6673)){
var t_6674 = temp__5823__auto___6673;
each_fixture_fn.call(null,((function (seq__6668,chunk__6669,count__6670,i__6671,t_6674,temp__5823__auto___6673,v,each_fixture_fn,G__6667,G__6667__$1,env,once_fixtures,each_fixtures,vec__6664,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_6674)));
});})(seq__6668,chunk__6669,count__6670,i__6671,t_6674,temp__5823__auto___6673,v,each_fixture_fn,G__6667,G__6667__$1,env,once_fixtures,each_fixtures,vec__6664,ns,vars__$1))
);
} else {
}


var G__6675 = seq__6668;
var G__6676 = chunk__6669;
var G__6677 = count__6670;
var G__6678 = (i__6671 + (1));
seq__6668 = G__6675;
chunk__6669 = G__6676;
count__6670 = G__6677;
i__6671 = G__6678;
...
var temp__5823__auto__ = cljs.core.seq.call(null,seq__6668);
if(temp__5823__auto__){
var seq__6668__$1 = temp__5823__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__6668__$1)){
var c__5525__auto__ = cljs.core.chunk_first.call(null,seq__6668__$1);
var G__6679 = cljs.core.chunk_rest.call(null,seq__6668__$1);
var G__6680 = c__5525__auto__;
var G__6681 = cljs.core.count.call(null,c__5525__auto__);
var G__6682 = (0);
seq__6668 = G__6679;
chunk__6669 = G__6680;
count__6670 = G__6681;
...
var v = cljs.core.first.call(null,seq__6668__$1);
var temp__5823__auto___6683__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5823__auto___6683__$1)){
var t_6684 = temp__5823__auto___6683__$1;
each_fixture_fn.call(null,((function (seq__6668,chunk__6669,count__6670,i__6671,t_6684,temp__5823__auto___6683__$1,v,seq__6668__$1,temp__5823__auto__,each_fixture_fn,G__6667,G__6667__$1,env,once_fixtures,each_fixtures,vec__6664,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_6684)));
});})(seq__6668,chunk__6669,count__6670,i__6671,t_6684,temp__5823__auto___6683__$1,v,seq__6668__$1,temp__5823__auto__,each_fixture_fn,G__6667,G__6667__$1,env,once_fixtures,each_fixtures,vec__6664,ns,vars__$1))
);
} else {
}


var G__6685 = cljs.core.next.call(null,seq__6668__$1);
var G__6686 = null;
var G__6687 = (0);
var G__6688 = (0);
seq__6668 = G__6685;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__6667__$1)].join('')));
